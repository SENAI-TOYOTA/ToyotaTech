      ...
      <div className="max-w-[1180px] mx-auto px-7">
        ...
        <div className="max-w-[680px] mb-10">
          ...
          <p className="text-ink-soft mt-3 text-[1rem]">
            Cada perfil entra pelo seu próprio caminho: cliente de um lado,
            gestão do outro — sem mistura de informações entre as duas áreas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5.5">
          ...
          <div className="bg-white border border-border rounded-[18px] shadow-toyota-sm p-7.5 md:p-7">
            ...
            <ul className="mb-6.5">
              <li className="text-[0.93rem] py-2.5 flex gap-2.5 items-start border-t border-border">
                <svg
                  className="w-[17px] h-[17px] shrink-0 text-toyota-red mt-0.5"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.4"
          ...
          <div className="bg-white border border-border rounded-[18px] shadow-toyota-sm p-7.5 md:p-7">
            ...
            <h3 className="text-[1.35rem] font-bold mb-2.5">
              Portal de Gestão
            </h3>
            <p className="text-[0.96rem] text-ink-soft mb-6.5 max-w-[380px]">
            ...
            <ul className="mb-6.5">
              <li className="text-[0.93rem] py-2.5 flex gap-2.5 items-start border-t border-border">
                <svg
                  className="w-[17px] h-[17px] shrink-0 text-charcoal mt-0.5"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2.4"
